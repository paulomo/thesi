...
import ManComputer from "../../../../common/images/man-computer.png";

export const Step = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-40 text-textSecondaryColor">
          ...
          <div className="flex">
            <div className="flex flex-col items-center mr-4">
              <div>
                <div className="flex items-center justify-center w-10 h-10 border rounded-full">
                  <svg
                    className="w-4 text-textSecondaryColor"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
            ...
            <div className="pt-1 pb-8">
              ...
              <p className="text-textSecondaryColor">
                Thesi will use your connected Instagram account to search 
          ...
          <div className="flex">
            <div className="flex flex-col items-center mr-4">
              <div>
                <div className="flex items-center justify-center w-10 h-10 border rounded-full">
                  <svg
                    className="w-6 text-textSecondaryColor"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                    <polyline
